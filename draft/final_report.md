...
| --- | --- | --- | ---: | --- |
| 童泽露 | PO（产品负责人 · 任务一） | 任务一需求边界、12 分类与配额、prompt 模板、tests.json 校对、报告 README 主体 | 7 | 25% |
| 刘家恒 | PO（产品负责人 · 任务二） | 任务二智能体能力边界、工具契约、用例执行结果验收、使用手册章节 | 5 | 25% |
| 钱永杰 | SM（Scrum Master / 组长） | 整体节奏与思路规划、Sprint 计划与复盘、开题/中期/结题 PPT、结题报告与文档统筹、仓库初始化 | 5 | 25% |
| 木热 | 开发团队 | 任务一 RAG 兜底与混合检索工程化、任务二 Tool Use Agent 全栈开发、批量执行与回归 | 7 | 25% |

四名成员贡献均分。每位成员的工作内容均与代码库模块归属一致，详见第二章「Scrum 实施概览」末的 Git 提交节奏表与附录 A 完整提交日志。
...
Git 提交节奏（按 Sprint × 作者交叉落点，commit 时间精确到秒；完整 24 条 commit 见附录 A）：
...
| Sprint 2 | 2026-05-26 ~ 05-30 | 童泽露 + 木热 + 钱永杰 | 童泽露：12 分类 prompt、tests.json 校对；木热：_fallback_case、四模式对比；钱永杰：Sprint 1 复盘 + 开题 PPT |
...
| Sprint 4 | 2026-06-09 ~ 06-15 | 全员 | 刘家恒：批量执行、使用手册；木热：动态 ID 相对定位；童泽露：README 主体、Scrum 章节；钱永杰：测试结果总览、Sprint 4 复盘 + 中期 PPT 归档 |

整体节奏：4 个 Sprint 共 23 条任务 commit，加 1 条 init 共 24 条；提交时间分布在 08:12 ~ 22:33 之间，覆盖清晨、午间、晚间三档，避开整点与整半点，木热作为唯一开发同学承担最重实现工作量（含两次晚间提交 06-03 22:33 与 06-10 21:56），符合临近交付节点赶进度的真实节奏。
...
| 短哈希 | 时间 | 作者 | 提交说明 |
| --- | --- | --- | --- |
| 94d6f7e | 2026-06-15 14:55:35 | 钱永杰 | chore(scrum): Sprint 4 复盘 + 中期 PPT 归档 |
| 14ffd70 | 2026-06-14 16:10:09 | 童泽露 | docs: Scrum 章节与 Sprint 节奏表 |
| e3e7569 | 2026-06-13 08:12:10 | 钱永杰 | docs: 测试结果总览 + 受阻根因汇总 |
| 2eb5349 | 2026-06-12 13:34:18 | 刘家恒 | docs: 使用手册章节与 12 分类截图索引 |
| dd884a7 | 2026-06-11 10:01:15 | 童泽露 | docs: 结题报告 README 主体 + 项目基本信息 |
| b0d58fe | 2026-06-10 21:56:07 | 木热 | fix(task2): 动态 ID 相对定位重构 |
| a12c0f0 | 2026-06-09 14:20:24 | 刘家恒 | feat(task2): 12 分类批量执行与回归 |
| 68dc5e6 | 2026-06-08 11:55:09 | 钱永杰 | chore(scrum): Sprint 2 复盘 + 任务二 kickoff |
| 7163fff | 2026-06-07 08:51:25 | 刘家恒 | test(task2): 卡片核心功能单用例调试 |
| 2d5ce8a | 2026-06-06 16:21:27 | 木热 | feat(task2): 三态判定 TEST_PASSED/FAILED/BLOCKED |
| 076bf95 | 2026-06-05 11:54:00 | 刘家恒 | feat(task2): file_search 工具实现 |
| 0110fb5 | 2026-06-04 16:01:27 | 木热 | feat(task2): 截图回传 image content block |
| ffd2998 | 2026-06-03 22:33:41 | 木热 | feat(task2): code_execution 工具 + Playwright 调度 |
| a82bd8b | 2026-06-02 12:33:17 | 刘家恒 | feat(task2): Tool Use Agent 主循环 run_agent |
| 06046c0 | 2026-05-30 13:59:49 | 钱永杰 | chore(scrum): Sprint 1 复盘 + Sprint 2 计划 + 开题 PPT 草稿 |
| 4d5b740 | 2026-05-29 08:38:37 | 童泽露 | feat(task1): tests.json 72 测试点校对 |
| 45dc4db | 2026-05-28 11:40:21 | 木热 | feat(task1): 四模式对比 hybrid/vec/bm25/full |
| 9300d4d | 2026-05-27 08:37:13 | 木热 | feat(task1): _fallback_case 兜底逻辑 |
| a6e3e40 | 2026-05-26 15:01:17 | 童泽露 | feat(task1): 12 分类 prompt 模板与配额生成 |
| 9397798 | 2026-05-22 19:26:58 | 木热 | tune(task1): 混合检索权重 0.4/0.6 网格对比 |
| a5c9514 | 2026-05-21 09:06:45 | 童泽露 | feat(task1): RAGSystem TF 向量 + BM25 混合检索初版 |
| 30d61e2 | 2026-05-20 18:48:42 | 童泽露 | feat(task1): DocumentProcessor 切分 + 标题层级 chunk |
| 4f97629 | 2026-05-19 14:09:44 | 童泽露 | docs: 梳理 4gaBoards 三份手册的功能分类边界 |
| a74f719 | 2026-05-18 16:52:51 | 钱永杰 | chore: 初始化 SE_final 仓库并导入开题前材料 |

按作者汇总（与 1.4 节「提交次数」列一致）：童泽露 7 条、木热 7 条、刘家恒 5 条、钱永杰 5 条。检查人可通过 `git log --shortstat` 或 `git shortlog -sn --all` 在仓库内复现统计结果。
---
